                ...
                <table className="w-full text-sm">
                    ...
                    <tbody>
                        ...
                        <tr className="border-t-2 border-slate-200 bg-slate-50">
                            <td className="px-3 py-4 text-slate-900">Net Salary</td>
                            <td className="text-right px-4 py-3 text-slate-900 font-bold text-lg">${paySlip.netSalary?.toLocaleString()}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
